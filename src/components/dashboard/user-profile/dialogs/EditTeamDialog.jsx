...
export function EditTeamDialog({
  ...
  const { logo, logoPreview, handleLogoChange, removeLogo, resetLogo } =
    useLogoUpload();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!data.success) {
        toast.error(
          hasTeam ? "Update Failed" : "Creation Failed",
          data.error || data.message || "Failed to save team",
        );
        return;
      }

      toast.team(
        hasTeam ? "Team Updated" : "Team Created",
        hasTeam
