    ...
    <>
      ...
      >
        ...
        <div className="px-3 py-2 border-b border-[#1e2330]">
          <p className="text-[9px] font-bold uppercase tracking-widest text-[#4e5d78]">
            Organizer Actions
          </p>
        </div>
...
export function TournamentCard({
  ...
  const openJoin = () => {
    if (!currentPlayer) {
      toast.error(
        ...
        "Create your player profile before joining tournaments",
      );
      return;
    }

    if (isPaid) {
      setShowPaidJoin(true);
    } else {
      setShowJoin(true);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.tournament(
        "Tournament Deleted",
        `${tournament.name} has been removed successfully`,
      );
    ...
    <>
      ...
      >
        ...
        {[
          ...
          <div
            key={i}
            className={`pointer-events-none absolute z-10 w-3 h-3 ${cls} border-[#ff6b00]`}
          />
        ))}
        ...
        <div className="relative overflow-hidden px-5 pt-5 pb-4 bg-gradient-to-br from-[#0f1318] via-[#1a1f2e] to-[#0f1318] border-b border-[#1e2330] rounded-t-xl">
          ...
          <div className="flex items-start justify-between mb-3">
            <div className="flex flex-wrap gap-1.5">
              ...
              <span
                className={`text-[10px] font-bold tracking-wider px-2.5 py-0.5 rounded uppercase border ${
                  isPaid
          ...
          <div className="flex justify-between items-start gap-4">
            ...
            <div className="text-right flex-shrink-0">
              ...
              <p className="text-[10px] text-[#5a6070] tracking-widest uppercase mt-0.5">
                Prize Pool
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 border-b border-[#1e2330]">
          {[
            ...
            {
              label: "Slots",
              value: isFull ? "Full 🔒" : `${totalSlots - filledSlots} left`,
              accent: isFull,
            },
          ].map((s, i) => (
            <div
            ...
            >
              <p className="text-[11px] text-[#4a5060] uppercase tracking-widest mb-1">
                {s.label}
              </p>
              <p
                className={`text-sm font-bold ${s.accent ? "text-red-400" : "text-[#d0d5df]"}`}
              >
                {s.value}
              </p>
            </div>
